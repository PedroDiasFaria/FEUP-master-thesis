...
%%----------------------------------------
\title{Test Automation in Continuous Integration for Hardware Validation}
\author{Pedro Dias Faria}
...
\supervisor{Supervisor}{Rui Filipe Lima Maranhão de Abreu}

\supervisor{\\ ~\\ \small Co- Supervisor:}{
\small
\\
